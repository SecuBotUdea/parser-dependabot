...
def map_dependabot_payload(raw_payload: dict) -> dict:
    ...
    package = {
        "name": raw_payload.get("dependency", {}).get("package", {}).get("name", "")
        or "",
        "ecosystem": raw_payload.get("dependency", {})
        .get("package", {})
        .get("ecosystem", "")
        or "",
    ...
    obj = {
        ...
        or raw_payload.get("alert", {}).get("created_at")
        or None,
        "package": package,
        "severity": raw_payload.get("security_advisory", {}).get("severity")
        or raw_payload.get("alert", {}).get("severity")
        or "unknown",
        "cvss": raw_payload.get("security_advisory", {}).get("cvss", None),
        "cve": raw_payload.get("security_advisory", {})
        .get("identifiers", {})
        .get("CVE", None),
        "description": raw_payload.get("security_advisory", {}).get("summary")
        or raw_payload.get("alert", {}).get("description"),
        "location": None,
        "raw": raw_payload,
    }
